...
import com.pranish.cardArranger.rules.all.DaabRun;
...
public class DaabRunTest {
    ...
    public void manualDaabRunTest() {
        ...
        try {
            ...
            List<Card> otherCards = CardConst.getCertainCards(8);
            CardFolder cardFolder = new CardFolder();
